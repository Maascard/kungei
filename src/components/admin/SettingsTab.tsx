...
const GROUPS: Group[] = [
  ...
  {
    title: "Услуги (каждая с новой строки, формат: Название|Описание|Цена)",
    fields: [
      { key: "services_ru", label: "Услуги (рус)", type: "textarea", hint: "Формат: Название|Описание|Цена. Напр.: Ночёвка|До 9 утра|60000 (цена необязательна)" },
      { key: "services_kk", label: "Услуги (қаз)", type: "textarea", hint: "Пішімі: Атауы|Сипаттама|Бағасы. Мыс.: Қону|Таңғы 9-ға дейін|60000" },
    ],
  },
  {
